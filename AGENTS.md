...
| FLARE as a fusion testbed | Avg fusion 5.86 vs vision 12.61 — ONE scalar gives **13.12** (renormalized family, w=0.87) — 5.86->13.12 without leaving the incumbent's operator. Per-query oracle 18.50, decoy null 0.01, **PROBE NULL REVERSED on the correct (renormalized) family**: learned w(q) 13.28 vs const 13.08, +0.192 [+0.093,+0.289], recovering 4.1% of the oracle gap. Groupings still null (5 arms, none beats a global w). So group-unrecoverable holds, probe-unrecoverable does NOT. Audio worth **+0.474** [+0.271,+0.664] nested; earlier +0.19-0.25 was the WRONG operator family (linear, not renormalized) |
